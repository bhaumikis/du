...
<table align="center" width="90%" cellpadding="2" cellspacing="2">
    ...
    for ($i = 0; $i < count($view->users); $i++) {
        ...
        <tr <?php echo $class; ?>>
            ...
            <td class="gridtd"><?php echo $view->users[$i]["utitle"]; ?></td>
            ...
            <td class="gridtd" align="center"><?php if ($view->users[$i]["status"] == 1) { ?>
                    <a href="<?php echo $module_url . "/users/changestatus/status/0/user_id/" . $view->users[$i]["user_id"]; ?>"><img src="<?php echo $module_url . "/images" . "/active.png"; ?>" border="0" title="<?php echo _l('Text_Active', 'common'); ?>"/></a>
                <?php } else { ?>
                    <a href="<?php echo $module_url . "/users/changestatus/status/1/user_id/" . $view->users[$i]["user_id"]; ?>"><img src="<?php echo $module_url . "/images" . "/inactive.png"; ?>" border="0" title="<?php echo _l('Text_Inactive', 'common'); ?>"/></a>
    <?php } ?>
            </td>
