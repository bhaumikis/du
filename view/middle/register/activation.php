...
?>
<header class="ac-activate-head">
</header>
<!-- Header -->
<!-- Right Menu -->
<div class="con-padding-tb">
    <div class="col-md-4"></div>
    <div class="col-md-4 ac-activate">
        <div class="active-logo-bg"> <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        <br>
        <p class="clearfix padding-top-15"><?php echo _l("Account_Activated", "users"); ?></p>
        <br>
        <button class="clearfix btns  orange sml-btn go-btn" onclick="window.location.href = '<?php echo $module_url; ?>'"><?php echo _l('Button_Go', 'common'); ?></button>
    </div>
    <div class="col-md-4"></div>
</div>