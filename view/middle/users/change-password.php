                    ...
                    <div class="custom-form">
                        <div class="col-sm-12">
                            <div class="inline-form">
                                <label class="c-label"><?php echo _l('Label_Old_Password', 'change_password'); ?><span class="error">*</span></label>
                        ...
                        <div class="col-sm-12">
                            <div class="inline-form">
                                <label class="c-label"><?php echo _l('Label_New_Password', 'change_password'); ?><span class="error">*</span></label>
                        ...
                        <div class="col-sm-12">
                            <div class="inline-form">
                                <label class="c-label"><?php echo _l('Label_Confirm_Password', 'change_password'); ?><span class="error">*</span></label>
