                ...
                <li class="border-btm">
                    <div class="col-xs-12 padding-top-10 padding-btm-10 dark-gray-txt">
                        <?php foreach($view->arrTripReference as $arrImages){?>
                            <div class="col-xs-4 padding-left-10 padding-right-0"><img src="<?php echo $module_url;?>/images/user_trips/<?php echo $arrImages['trip_filename'];?>" class="col-xs-12 no-round-brd"/></div>
                        <?php }?>
                    </div>      
                </li>
                 <?php } ?>
