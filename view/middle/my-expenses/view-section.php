                    ...
                    <li class="border-btm">
                        <div class="col-xs-12 padding-top-10 padding-btm-10 dark-gray-txt">
                            ...
                            <?php foreach ($view->arrExpenseReference as $arrImages) { ?>
                                <div class="col-xs-4 padding-left-10 padding-right-0"><img src="<?php echo $module_url; ?>/images/user_expenses/<?php echo $arrImages['expense_filename']; ?>" class="col-xs-12 no-round-brd"/></div>
                                <?php } ?>
                        </div>
                    </li>
                <?php } ?>
